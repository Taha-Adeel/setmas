...
export default class AcceptRequestsClass extends Component {
  ...
  CancelDialog(pendingRequest) {
    this.dialog.show({
      body: generateDialogBody(pendingRequest),
      bsSize: 'large',
      actions: [
        Dialog.CancelAction(),
        Dialog.OKAction(() => { console.log('Cancel is clicked'); console.log(pendingRequest); })
      ]
    });
  }
  createFormattedRequestsList() {
    ...
    const pendingRequests = [
      {
        ...
        "seminardate": "2023-05-22",
        "seminarstart": "13:39",
        "seminarend": "15:41",
        "title": "On How to not be a funny man",
        "desc": "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
        "venue": "B114",
        "CSMAIL": "true",
        "AIMAIL": "false",
      ...
      },
      {
        "name": "John Wick",
        "dept": "CHE",
        "email": "ch20btech11001",
        "seminardate": "2023-04-4",
        "seminarstart": "07:39",
        "seminarend": "09:41",
        "title": "The final duel against the marquis",
        "desc": 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
        "venue": "ALH1",
        "CSMAIL": "false",
        "AIMAIL": "false",
      ...
      },
      {
        ...
        "dept": "SEN",
        "email": "senhalo@iith.ac.in",
        "seminardate": "2023-04-20",
        "seminarstart": "19:39",
        "seminarend": "20:41",
        "title": "Halo gaming session",
        "desc": "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
        "venue": "Auditorium",
        "CSMAIL": "false",
        "AIMAIL": "false",
  ...
  getRequestEntry(pendingRequest, num) {
    return (
      ...
      <td>{mergeRemainders(pendingRequest)}</td> */}
      <td>
        <Button onClick={() => {this.CancelDialog(pendingRequest)}}>
          Cancel
        </Button>
      </td>
      </>
        ...
        <Container fluid>
          <Row>
            <Col md="12">
              <Card className="card-plain table-plain-bg">
                <Card.Header>
                  <Card.Title as="h4">Approved requests</Card.Title>
                  <p className="card-category">
                    Here is a list of all the requests that have been accepted. Click on the button to cancel an already approved request This action will not generate a corresponding pending request. 
                  </p>
                </Card.Header>
                <Card.Body className="table-full-width table-responsive px-0">
                  <Table className="table-hover">
